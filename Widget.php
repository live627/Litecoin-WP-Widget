...
function getLitecoinPrice() {
	...
	// Widget output //
			...
			<p style="font-size:10px;">
				Send me some Litecoins! <?php echo $donation_address; ?>
			</p>
			<?php }
	...
	// Widget Control Panel //
		...
		<p>
			<label for="<?php echo $this->get_field_id('show_price'); ?>"><?php _e('Show the Litecoin price?'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('donate_litecoins'); ?>"><?php _e('Add a litecoin donation address?'); ?></label>
			<input type="checkbox" class="checkbox" <?php checked( $instance['donate_litecoins'], 'on' ); ?> id="<?php echo $this->get_field_id('donate_litecoins'); ?>" name="<?php echo $this->get_field_name('donate_litecoins'); ?>" />
		</p>
		<p>
